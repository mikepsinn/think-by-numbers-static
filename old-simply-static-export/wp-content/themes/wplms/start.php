            ...
            <div class="col-md-9">
                ...
                if(isset($course_curriculum) && is_array($course_curriculum) && count($course_curriculum)){
                  ...
                  echo  '<div class="col-md-6">
                          '.((isset($done_flag) && $done_flag)?'': ((get_post_type($units[($k)]) == 'quiz')? '<a href="'.get_permalink($units[($k)]).'">'.__('Proceed to Quiz','vibe').'</a>':'<a href="#" id="mark-complete" data-unit="'.$units[($k)].'" class="unit_button">'.__('Mark this Unit Complete','vibe').'</a>')).
                        '</div>';
