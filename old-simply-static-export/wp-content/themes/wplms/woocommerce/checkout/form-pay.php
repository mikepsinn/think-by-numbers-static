...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<ul class="payment_methods methods">
			<?php
				if ( $available_gateways = $woocommerce->payment_gateways->get_available_payment_gateways() ) {
					...
					echo '<p>'.__( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'vibe' ).'</p>';
		...
		<div class="form-row">
			...
			<input type="submit" class="button alt" id="place_order" value="<?php _e( 'Pay for order', 'vibe' ); ?>" />
