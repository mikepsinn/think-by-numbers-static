...
$course_settings = array(
    ...
    'vibe_course_certificate_template' =>'',
    'vibe_badge' => 'S',
            ...
            <div class="col-md-3 col-sm-3">      
                <div id="course_creation_tabs" class="course-create-steps">
                    <ul <?php echo ((isset($_GET['action']))?'class="islive"':'');?>>
                        ...
                        ?>
                        <li><i class="icon-tag"></i><a><?php _e('MEMBERSHIPS','vibe'); ?><span><?php _e('Set Membership access','vibe'); ?></span></a></li>
                        <?php
                        }
                        ?>
                ...
                <div class="create_course_content content">
                    <div id="create_course" class="active">
                        <article class="live-edit" data-model="article" data-id="1" data-url="/articles">
                            ...
                            <ul id="course-category" data-help-tag="2">
                                <li>
                                    <select id="course-category-select" class="chosen">
                                        ...
                                        <?php
                                        $terms = get_terms('course-cat',array('hide_empty' => false,'fields' => 'id=>name'));
                                        if(isset($terms) && is_array($terms))
                                        foreach($terms as $key=>$term){
                                            echo '<option value="'.$key.'" '.(isset($_GET['action'])?selected($course_cat_id,$key):'').'>'.$term.'</option>';
                                        }
                                        ?>
                            ...
                            ?>
                            <div class="clear"></div>
                            <h3 class="course_status"><?php _e('Change Course Status','vibe'); ?><span>
                                    <div class="switch">
                    ...
                    <div id="course_settings">
                        ...
                        <article class="live-edit" data-model="article" data-id="1" data-url="/articles">
                        <ul>
                            <li data-help-tag="5"><label><?php _e('Course Duration','vibe'); ?></label>
                                <h3><?php _e('Maximum Course Duration','vibe'); ?><span><input type="number" id="vibe_duration" class="small_box" value="<?php echo $course_settings['vibe_duration']; ?>" /><?php _e('days','vibe'); ?></span></h3></li>
                            <li data-help-tag="6"><label><?php _e('Course Evaluation','vibe'); ?></label>
                            ...
                            <li data-help-tag="7"><label><?php _e('Pre-required Course','vibe'); ?></label>
                            ...
                            <li data-help-tag="8"><label><?php _e('Drip Feed','vibe'); ?></label>
                                ...
                                <ul>
                                    <li><h5><?php _e('Set Drip Feed Duration','vibe'); ?><span><input type="number" id="vibe_course_drip_duration" class="small_box" value="<?php echo $course_settings['vibe_course_drip_duration']?>" /><?php _e('days','vibe'); ?></span></h5></li>
                                </ul>    
                            </li>
                            <li data-help-tag="9"><label><?php _e('Course Certificate','vibe'); ?></label>
                            <h3><?php _e('Course Certificate','vibe'); ?><span>
                                ...
                                <ul <?php if($course_settings['vibe_course_certificate'] == 'S'){echo 'style="display:block;"';} ?>>
                                    ...
                                    <select id="vibe_course_certificate_template" class="chosen">
                                    ...
                                    <?php
                                        ...
                                        $kposts=get_posts($args);
                                        foreach ( $kposts as $kpost ){
                                            echo '<option value="' . $kpost->ID . '" '.selected($course_settings['vibe_course_certificate_template'],$kpost->ID).'>' . $kpost->post_title . '</option>';
                                        }
                                    ?>
                                    </select></span></h5></li>
                                </ul> 
                            </li>
                            <li data-help-tag="10"><label><?php _e('Course Badge','vibe'); ?></label>
                                ...
                                <ul <?php if($course_settings['vibe_badge'] == 'S'){echo 'style="display:block;"';} ?>>
                                    ...
                                    <li><h5><?php _e('Upload Badge Image','vibe'); ?><span>
                                         <div id="badge_image" class="upload_badge_button" data-input-name="vibe_course_badge" data-uploader-title="Upload a Badge Image" data-uploader-button-text="Set as Badge" data-uploader-allow-multiple="false">
                                            ...
                                            <input id="vibe_course_badge" type="hidden" value="<?php echo $course_settings['vibe_course_badge']; ?>" />
                                        </div>
                                    </span></h5></li>
                                </ul> 
                            </li>
                            <li data-help-tag="11"><label><?php _e('Course Group','vibe'); ?></label>
                            ...
                            <li data-help-tag="12"><label><?php _e('Course Forum','vibe'); ?></label>
                            ...
                            <li data-help-tag="13"><label><?php _e('Course Completion Message','vibe'); ?></label>
                            <div id="vibe_course_message" data-help-tag="4" data-editable="true" data-name="content" data-max-length="1000" data-text-options="true">
                            <?php
                    ...
                    <div id="course_curriculum">
                                        ...
                                        if(get_post_type($kid) == 'unit'){
                                            echo '<li><h3 class="title" data-id="'.$kid.'"><i class="icon-file"></i> '.get_the_title($kid).'</h3>
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="'.get_permalink($kid).'?id='.$_GET['action'].'&edit" target="_blank" class="edit_unit">'.__('Edit Unit','vibe').'</a></li>
                                            ...
                                            echo '<li><h3 class="title" data-id="'.$kid.'"><i class="icon-task"></i> '.get_the_title($kid).'</h3>
                                                    ...
                                                    <button type="button" class="btn btn-course dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="'.get_permalink($kid).'?id='.$_GET['action'].'&edit" target="_blank" class="edit_quiz">'.__('Edit Quiz','vibe').'</a></li>
                                                        <li><a class="remove">'.__('Remove','vibe').'</a></li>
                                                        <li><a class="delete">'.__('Delete','vibe').'</a></li>
                                                    </ul>
                                                    </div>
                        ...
                        <ul id="hidden_base">
                            ...
                            <li class="new_quiz" data-help-tag="16">
                                <select>
                    ...
                    <div id="course_pricing">
                        ...
                        <ul>
                            <li><h3><?php _e('Free Course','vibe'); ?><span>
                                        <div class="switch" data-help-tag="17">
                            ...
                            <li class="course_product" data-help-tag="18">
                            ...
                            <li class="new_product">
                                <h3><?php _e('Set Product type'); ?><span>
                            ...
                            <li class="new_product">
                                <h5><?php _e('Set Product Price'); ?><span>
                                <input type="text" id="product_price" class="small_box" />
                                <?php echo get_woocommerce_currency(); ?></span></h5>
                                <h5 class="product_duration"><?php _e('Set Subscription duration')?><span>
                        ...
                        if ( in_array( 'paid-memberships-pro/paid-memberships-pro.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) && function_exists('pmpro_getAllLevels')) { 
                            ?>
                            <h3 class="heading"><?php _e('Course Membership','vibe'); ?></h3>
                            <?php
                            ...
                            <li><h3><?php _e('Set Course Memberships','vibe'); ?><span>
                            ...
                            <a id="save_membership" class="button hero"><?php _e('Save Course Membership','vibe'); ?></a>
                        <?php    
                        }
                        ?>
                    </div>
            ...
            <div class="col-md-3 col-sm-3">      
                <div class="course-create-help">
                    ...
                    <ul id="course_settings_help">
                        ...
                        <li><span>7</span><?php _e('Connect a Course Group OR Create a new one','vibe'); ?></li>
                        <li><span>8</span><?php _e('Connect a Course forum Or Create a new one or Create a Course Group Forum','vibe'); ?></li>
                        <li><span>9</span><?php _e('Enter message which student see after submitting the course.','vibe'); ?></li>
                    </ul>
