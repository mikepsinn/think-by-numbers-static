...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
                        ...
                        'type' => 'button_set',
						'options' => array('' => 'All Activity','1'=>'Student Activity'),//Must provide key => value pairs for radio options
						'std' => ''
						),									
					)
				);
...
$sections[] = array(
				...
				'fields' => array(
                        ...
                        'type' => 'button_set',
						'options' => array('pending' => 'Yes, require approval','publish'=>'No, allow publish'),
						'std' => '0'
						),
						array(
						'id' => 'nextunit_access',
