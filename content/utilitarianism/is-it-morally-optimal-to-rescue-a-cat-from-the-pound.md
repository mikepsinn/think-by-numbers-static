...
description: >-
  Saving one cat kills 600 chickens over 15 years. Utilitarianism proves petting
  your cat is morally worse than euthanizing it.
authors: []
...
1. Weighs all animal suffering equally (1 cat = 600 chickens)
2. Counts only quantified utility (feelings don't matter, only numbers)
3. Ignores special obligations to relationships (your cat is no more important than a random chicken in Iowa)
4. Follows the math wherever it leads (even when it leads to killing your cat)
...
Most people will rescue the cat and feel vaguely guilty about the chickens. This is probably the least-worst option for creatures who have both emotions AND calculators but aren't very good at using either.

**What this reveals:**
The math says euthanize. Your heart says rescue. The gap between them is either:
...
1. The math is missing something important
2. Morality isn't math
3. Your cat is doomed
