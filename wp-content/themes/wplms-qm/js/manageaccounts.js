...
ManageAccountsPage = function() {
	...
	function setToSyncing(connectorName) {
		...
		syncLED.html("<span class=\"syncLED-waiting\">"
				+ "<img src=\"http://i.imgur.com/PlIolkh.gif\" alt=\"load\">"
				+ "</span>");
								...
								case 'quantifiedmind':
									el
											.html('<form name="'
													...
													+ '<label for="'
													+ connectorName
													+ '-username"><a href="http://quantified-mind.com/authenticate/get_token" target="_blank">Username</a>: <input type="text" name="username" value="" size="15"></label>'
													+ '<label for="'
													+ connectorName
													+ '-token"><a href="http://quantified-mind.com/authenticate/get_token" target="_blank">Token</a>: <input type="text" name="token" value="" size="15"></label>'
													+ '<input type="submit" value="Connect">'
													+ '</form>');
								case 'mymee':
									el
