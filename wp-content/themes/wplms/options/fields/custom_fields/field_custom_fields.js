jQuery(document).ready(function(){
	jQuery('.vibe-opts-custom-fields-remove').live('click', function(){ 
		jQuery(this).parent().fadeOut('slow', function(){jQuery(this).remove();});
	});
	
	jQuery('.vibe-opts-custom-fields-add').click(function(){ 	
       ...
       jQuery('.sortable_vibe_custom_fields').sortable({
       ...
       jQuery('.sortable_vibe_custom_fields').disableSelection();
